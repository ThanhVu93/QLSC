<%@ Control Language="C#" AutoEventWireup="true" CodeFile="QLHD_DS.ascx.cs" Inherits="QLHD.QLHD_DS" %>
...
<asp:UpdatePanel runat="server" ID="uppnl">
    ...
    <ContentTemplate>
        <asp:Panel ID="pnlFormDanhSach" runat="server" CssClass="form">
            <div class="form-inline">
                ...
                <div class="col-md-5 pd-l0">
                    <asp:TextBox ID="txt_TK_NoiDung" OnTextChanged="txt_TK_NoiDung_TextChanged" runat="server" AutoPostBack="true" Visible="true" placeholder="Số hợp đồng, Tên công trình" MaxLength="200" Width="100%" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="col-md-2 pd-l0">
                    <asp:DropDownList ID="drpTrangThai" OnSelectedIndexChanged="drpTrangThai_SelectedIndexChanged" AutoPostBack="True" runat="server" CssClass="form-control" Width="100%">
                ...
                <div class="form-group fright">
                    <asp:LinkButton ID="btn_XuatExcel" OnClick="btn_XuatExcel_Click"  Visible="true" runat="server" CssClass="btn btn-default waves-effect none-radius none-shadow btn-sm min-width-100 mr-t3 mr-b6 mr-r3"><i class="glyphicon glyphicon-export"></i> Xuất Excel</asp:LinkButton>
            ...
            <asp:DataGrid runat="server" ID="dgDanhSach" AutoGenerateColumns="False" OnInit="dgCustom_Init" OnItemDataBound="dgDanhSach_ItemDataBound" OnPageIndexChanged="dgDanhSach_PageIndexChanged" AllowPaging="True" AllowCustomPaging="true" OnItemCreated="dgDanhSach_ItemCreated" AllowSorting="True">
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="Tên công trình">
                        ...
                        <ItemTemplate>
                             <a onserverclick="dsXemCT" id="hplChiTiet" title="Xem chi tiết" href='<%# Eval("HD_ID").ToString() %>' oncontextmenu="return false" runat="server" style="color: #1f91f3;">
                    ...
                    <asp:TemplateColumn HeaderText="Gia hạn">
                        ...
                        <ItemTemplate>
                            ...
                            <a onserverclick="dggianhan" oncontextmenu="return false" href='<%#DataBinder.Eval(Container,"DataItem.HD_ID")%>' runat="server">
                    ...
                    <asp:TemplateColumn HeaderText="Kết thúc">
                        ...
                        <HeaderStyle Width="3%" HorizontalAlign="Center" />
                        <ItemTemplate>
                            <a onserverclick="ketthucHD" onclick='<%#DataBinder.Eval(Container,"DataItem.HD_TRANGTHAI").ToString() != "1"?"return ConfirmKetThucHopDong();":"return ConfirmHuyKetThucHopDong();"%>' oncontextmenu="return false" href='<%#DataBinder.Eval(Container,"DataItem.HD_ID")%>' runat="server">
        ...
        <div class="col-sm-12 note_form" style="line-height: 20px">
            <b>Ghi chú: </b>
