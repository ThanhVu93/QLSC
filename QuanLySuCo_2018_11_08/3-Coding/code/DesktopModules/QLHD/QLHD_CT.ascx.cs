...
namespace QLHD
{
    public partial class QLHD_CT : DotNetNuke.Entities.Modules.UserModuleBase
    {
        #region Khai báo, định nghĩa đối tượng

        private readonly ILog log = LoggerSource.Instance.GetLogger(typeof(QLHD_CT).FullName);
        ...
        public void SetInfoForm(int HD_ID)
        {
            ...
            else
            {
                ...
                txtTenHopDong.ReadOnly = true;
                txtSoHopDong.ReadOnly = true;
                txtNgayKy.DateInput.ReadOnly = true;
                txtHieuLucHopDong.DateInput.ReadOnly = true;
                txtThoiGianThucHien.ReadOnly = true;
                txtNgayHetHanHongDong.DateInput.ReadOnly = true;
                txtGiaTri.ReadOnly = true;
                txtTGDenHanHD.ReadOnly = true;
                txtGhiChu.ReadOnly = true;

                txtDonViThiCong.ReadOnly = true;
                txtNgayKhoiCong.DateInput.ReadOnly = true;
                txtThoiGianThiCong.ReadOnly = true;
                txtNgayHetHanThiCong.DateInput.ReadOnly = true;
                txtTGDenHanThiCong.ReadOnly = true;

                txtBLThucHienHopDongTuNgay.DateInput.ReadOnly = true;
                txtBLThucHienHopDongDenNgay.DateInput.ReadOnly = true;
                txtTGDenHanBLThucHienHD.ReadOnly = true;
                txtBLThanhToanVatTuTuNgay.DateInput.ReadOnly = true;
                txtBLThanhToanVatTuDenNgay.DateInput.ReadOnly = true;
                txtTGDenHanBLThanhToanVatTu.ReadOnly = true;
                txtBLTamUngTuNgay.DateInput.ReadOnly = true;
                txtBLTamUngDenNgay.DateInput.ReadOnly = true;
                txtTGDenHanBLTamUng.ReadOnly = true;
