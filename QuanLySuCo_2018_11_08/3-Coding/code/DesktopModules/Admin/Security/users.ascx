...
<div class="dnnForm custom-form dnnUsers dnnClear" id="dnnUsers">
    <div class="dnnFormItem">
        <asp:textbox id="txtSearch" Runat="server" MaxLength="50" CssClass="dnnUserSearchInput dnnFixedSizeComboBox"/>
        <dnn:DnnComboBox id="ddlSearchType" Runat="server" CssClass="dnnUsersSearchFilter dnnFixedSizeComboBox"  />
        <asp:LinkButton ID="cmdSearch" runat="server" resourcekey="Search" CssClass="btn btn-default cam btn-sm dnnUsersSearchFilter" />        
    </div>
    ...
    <div>
        ...
        <li><asp:HyperLink id="addUserButton" runat="Server" CssClass="btn btn-default cam btn-sm" resourcekey ="AddContent.Action" Visible="false" /></li>
		<li><asp:LinkButton id="removeDeletedButton" runat="server" CssClass="btn btn-default btn-sm" resourcekey="RemoveDeleted.Action" Visible="false" /></li>
		<li><asp:LinkButton id="deleteUnAuthorizedButton" runat="server" CssClass="btn btn-default btn-sm" resourcekey="DeleteUnAuthorized.Action" Visible="false" /></li>
	</ul>
</div>
