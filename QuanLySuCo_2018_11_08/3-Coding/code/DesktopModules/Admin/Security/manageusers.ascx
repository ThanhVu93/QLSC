...
<div class="dnnForm dnnManageUsers dnnClear custom-form" id="dnnManageUsers" runat="server" ClientIDMode="Static">
...
<asp:Panel CssClass="dnnForm" runat="server" id="dnnFormActionControl">
    <ul id="actionsRow" runat="server" visible="false" class="dnnActions dnnClear">
        <li><asp:LinkButton id="cmdAdd" runat="server" CssClass="btn btn-default cam btn-sm" /></li>
        <li><asp:LinkButton id="cmdCancel" runat="server" CssClass="btn btn-default btn-sm" resourcekey="cmdCancel" CausesValidation="false" /></li>
        <li><asp:Hyperlink id="loginLink" runat="server" CssClass="btn btn-default cam btn-sm" resourcekey="cmdLogin" Visible="false" /></li>
    </ul>
</asp:Panel>	    