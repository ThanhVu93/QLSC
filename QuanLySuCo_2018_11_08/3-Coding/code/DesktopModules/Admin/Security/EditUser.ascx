...
<div class="dnnForm dnnEditUser dnnClear custom-form" id="dnnEditUser" runat="server" ClientIDMode="Static">
    ...
    <div id="dnnUserDetails" class="dnnUserDetails dnnClear">
        ...
        <div class="dnnForm dnnClear custom-from-action">
    ...
    <div id="dnnUserSubscriptions" class="dnnUserSubscriptions" runat="server" visible="false">
