...
<div class="dnnForm dnnLogViewer dnnClear" id="dnnLogViewer">
    ...
    <%--<fieldset>--%>
		<div class="dnnClear">        
			<div class="dnnlvOptions" runat="server" id="divPortal" visible="true">
			...
			<asp:Repeater EnableViewState="False" runat="server" ID="dlLog">
				<HeaderTemplate>
					<div class="dnnLogHeader dnnClear">
						...
						<div style="width:190px; text-align: center;"><%= Localization.GetString("Date", this.LocalResourceFile) %></div>
						<div style="width:100px; text-align: center;"><%= Localization.GetString("Type", this.LocalResourceFile) %></div>
						<div style="width:160px; text-align: center;"><%= Localization.GetString("Username", this.LocalResourceFile) %></div>
						<div style="width:120px; text-align: center;"><%= Localization.GetString("Portal", this.LocalResourceFile) %></div>
						<div style="width:280px; text-align: center;"><%= Localization.GetString("Summary", this.LocalResourceFile) %></div>
					</div>
				</HeaderTemplate>
				<ItemTemplate>
					<div class='dnnLogItemHeader'>
						...
						<div style="width:100px"><%# GetMyLogType(DataBinder.Eval(Container.DataItem,"LogTypeKey").ToString()).LogTypeFriendlyName %>&nbsp;</div>
						<div style="width:160px"><%# DataBinder.Eval(Container.DataItem,"LogUserName") %>&nbsp;</div>
    ...
    <div  id="divGui" runat="server" visible="false">
