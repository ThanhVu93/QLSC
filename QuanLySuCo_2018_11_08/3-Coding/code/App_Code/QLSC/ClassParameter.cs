...
namespace QLSC
{
    public class ClassParameter
    {
        ...
        public static string vPathCommonToastJS = DotNetNuke.Common.Globals.ApplicationPath.ToString() + "/DesktopModules/QLSC/Scripts/toastr.js";
        public static string vPathCommonToastCSS = DotNetNuke.Common.Globals.ApplicationPath.ToString() + "/DesktopModules/QLSC/css/toastr.css";
